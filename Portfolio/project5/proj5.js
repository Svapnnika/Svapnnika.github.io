...
function showHome() {
  ...
  let str = `
   <div class='container-fluid'>
     ...
     <div class='row'>
      <div class='bg-secondary text-dark justify-content-center p-3'>
...
function displayUsers(data) {
  ...
  str += `</select><p><button class='form-control m-3 btn btn-secondary' onclick='showHome()'>Log In</button></p></div></div>`;
  root.innerHTML = str;
}